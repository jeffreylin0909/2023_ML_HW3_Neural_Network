...
- Dense(self, n_x, n_y, seed=1): an n_x × n_y Fully Connected Dense layer of FCNN.
...
- advanced_data.npz: MNIST handwritten digit dataset, which get 91.64% accuracy on validation data.
